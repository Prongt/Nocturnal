...
//Core Logging Macros
#define NOC_CORE_INFO(...)  ::Nocturnal::Log::GetCoreLogger()->trace(__VA_ARGS__)
#define NOC_CORE_TRACE(...) ::Nocturnal::Log::GetCoreLogger()->info(__VA_ARGS__)
...
#define NOC_INFO(...)  ::Nocturnal::Log::GetClientLogger()->trace(__VA_ARGS__)
#define NOC_TRACE(...) ::Nocturnal::Log::GetClientLogger()->info(__VA_ARGS__)
